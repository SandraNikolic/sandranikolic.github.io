...
<?php _e('Get support', 'advanced-iframe'); ?>       </h2>
    <p>
      <?php _e('The basic settings are the settings a normal iframe solution does offer. They don\'t require any specific html, css or programming knowhow.' , 'advanced-iframe'); ?>
    </p>
    <p>
