...
printQuickstartGuide();
  ...
  echo '<table class="form-table hide-print">';
      ...
      printAllWarningFalse($devOptions, __('Check iframes on save', 'advanced-iframe'), 'check_iframes_when_save', __('You can define if you show errors only, errors and warnings or if iframes are not checked at all at save. Some servers do block this feature and you get a blank page on save once. If this is the case the plugin does disable this check automatically. You can enable this feature again if you allow curl calls on your server.', 'advanced-iframe') );
...
<div>
  ...
  echo '</h2>
  <p>';
  _e('<p>Advanced iframe is <strong>free for personal use</strong> and the Pro version a bargain for your business. The personal version does already contain many of the cool features of the Pro version. It has a limit of 10.000 views a month without a notice text which should normaly not been hit by a personal website.</p>', 'advanced-iframe' );
