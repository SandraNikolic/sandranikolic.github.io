...
get_header(); ?>
    ...
    <h1 class="kt-post-entry-title kt-category-title">
        <?php if (is_year()):
            echo __('Archive for: ', 'italian-restaurant') . get_the_time('Y');
        elseif (is_month()):
            echo __('Archive for ', 'italian-restaurant') . get_the_time('F, Y');
        elseif (is_day()):
            echo __('Archive for ', 'italian-restaurant') . get_the_time('F jS, Y');
        endif;
        ?>
